const SitesPage = {
  async render() {
    ...
    extraActions.innerHTML = `
      <button class="btn btn-secondary" style="background: rgba(255,255,255,0.05); color: #fff; border: 1px solid rgba(255,255,255,0.1); padding: 8px 16px; border-radius: 8px; font-weight: 600; display: flex; align-items: center; gap: 8px;">
        <i data-lucide="layout"></i> Meus Sites
      </button>
      <button class="btn btn-primary" style="background: #8b5cf6; color: #fff; padding: 8px 16px; border-radius: 8px; font-weight: 600; display: flex; align-items: center; gap: 8px; border:none;">
