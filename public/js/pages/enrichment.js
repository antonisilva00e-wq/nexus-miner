...
const EnrichmentPage = {
  async render() {
    document.getElementById('page-title').textContent = 'AI Enrichment';
    document.getElementById('page-subtitle').textContent = 'Automate and enrich your leads with intelligent data';
    ...
    document.getElementById('page-enrichment').innerHTML = `
      <div class="card" style="margin-bottom:1.5rem;">
        <div style="display:flex;align-items:center;gap:0.75rem;margin-bottom:1rem;">
          ...
          <div><h3 style="color:white;font-size:1.1rem;">Enrichment Statistics</h3><p style="color:var(--text-tertiary);font-size:0.8rem;">Overview of lead enrichment</p></div>
        </div>
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:1.5rem;margin-bottom:1.5rem;">
        <div class="card">
          <div style="display:flex;align-items:center;gap:0.75rem;margin-bottom:1rem;">
            ...
            <h3 style="color:white;font-size:1rem;">Batch Enrich</h3>
          </div>
          <p style="color:var(--text-secondary);font-size:0.85rem;margin-bottom:1rem;">Automatically enrich all leads without data using AI.</p>
          <div style="display:flex;gap:0.75rem;align-items:end;">
            ...
            <button class="btn btn-primary" onclick="EnrichmentPage.enrichAll()" id="btn-enrich-all" style="height:42px;"><i data-lucide="sparkles"></i>Enrich</button>
          </div>
        </div>
        ...
        <div class="card">
          <div style="display:flex;align-items:center;gap:0.75rem;margin-bottom:1rem;">
            ...
            <h3 style="color:white;font-size:1rem;">Enrich Specific Lead</h3>
          </div>
          <p style="color:var(--text-secondary);font-size:0.85rem;margin-bottom:1rem;">Search and enrich a specific lead by name or CNPJ.</p>
          <div style="display:flex;gap:0.75rem;align-items:end;">
            <div class="form-group" style="flex:1;">
              <label>Search Lead</label>
              <input type="text" id="enrich-search" placeholder="Name or CNPJ..." style="width:100%;padding:0.7rem;background:rgba(255,255,255,0.04);border:1px solid var(--border-color);border-radius:var(--border-radius-sm);color:var(--text-primary);">
            </div>
            <button class="btn btn-secondary" onclick="EnrichmentPage.searchLead()" style="height:42px;"><i data-lucide="search"></i>Search</button>
          </div>
        </div>
      </div>
      ...
      <div class="card" style="margin-bottom:1.5rem;">
        <div style="display:flex;align-items:center;gap:0.75rem;margin-bottom:1rem;">
          ...
          <h3 style="color:white;font-size:1rem;">Enrichment Sources</h3>
        </div>
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:1rem;">
          <div style="display:flex;align-items:center;gap:0.75rem;padding:0.75rem;background:rgba(66,133,244,0.06);border:1px solid rgba(66,133,244,0.12);border-radius:8px;">
            ...
            <div><p style="color:white;font-size:0.85rem;font-weight:500;margin:0;">Google Maps</p><p style="color:var(--text-tertiary);font-size:0.75rem;margin:0;">Location and address</p></div>
          </div>
          <div style="display:flex;align-items:center;gap:0.75rem;padding:0.75rem;background:rgba(245,158,11,0.06);border:1px solid rgba(245,158,11,0.12);border-radius:8px;">
            ...
            <div><p style="color:white;font-size:0.85rem;font-weight:500;margin:0;">Receita Federal</p><p style="color:var(--text-tertiary);font-size:0.75rem;margin:0;">CNPJ data</p></div>
          </div>
          <div style="display:flex;align-items:center;gap:0.75rem;padding:0.75rem;background:rgba(228,64,95,0.06);border:1px solid rgba(228,64,95,0.12);border-radius:8px;">
            ...
            <div><p style="color:white;font-size:0.85rem;font-weight:500;margin:0;">Social Media</p><p style="color:var(--text-tertiary);font-size:0.75rem;margin:0;">Instagram, Facebook</p></div>
          </div>
          <div style="display:flex;align-items:center;gap:0.75rem;padding:0.75rem;background:rgba(139,92,246,0.06);border:1px solid rgba(139,92,246,0.12);border-radius:8px;">
            ...
            <div><p style="color:white;font-size:0.85rem;font-weight:500;margin:0;">AI Scoring</p><p style="color:var(--text-tertiary);font-size:0.75rem;margin:0;">Intelligent score</p></div>
          </div>
          <div style="display:flex;align-items:center;gap:0.75rem;padding:0.75rem;background:rgba(239,68,68,0.06);border:1px solid rgba(239,68,68,0.12);border-radius:8px;">
            ...
            <div><p style="color:white;font-size:0.85rem;font-weight:500;margin:0;">Competition</p><p style="color:var(--text-tertiary);font-size:0.75rem;margin:0;">Market analysis</p></div>
          </div>
        </div>
      </div>
    ...
    try {
      ...
      el.innerHTML = `
        ...
        <div style="background:rgba(16,185,129,0.06);border:1px solid rgba(16,185,129,0.12);border-radius:var(--border-radius-md);padding:1rem;">
          <p style="color:var(--text-tertiary);font-size:0.75rem;margin:0 0 4px;">Enriched</p>
        ...
        <div style="background:rgba(245,158,11,0.06);border:1px solid rgba(245,158,11,0.12);border-radius:var(--border-radius-md);padding:1rem;">
          <p style="color:var(--text-tertiary);font-size:0.75rem;margin:0 0 4px;">Pending</p>
        ...
        <div style="background:rgba(59,130,246,0.06);border:1px solid rgba(59,130,246,0.12);border-radius:var(--border-radius-md);padding:1rem;">
          <p style="color:var(--text-tertiary);font-size:0.75rem;margin:0 0 4px;">Enrichment Rate</p>
  ...
  async enrichAll() {
    ...
    try {
      ...
      resultsEl.innerHTML = `
        <div class="card" style="grid-column:1/-1;">
          <div style="display:flex;align-items:center;gap:0.75rem;margin-bottom:1rem;">
            ...
            <h3 style="color:white;font-size:1rem;">Enrichment Result</h3>
          </div>
          <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:1rem;margin-bottom:1rem;">
            <div style="text-align:center;padding:1rem;background:rgba(16,185,129,0.06);border-radius:8px;">
              ...
              <p style="color:var(--text-tertiary);font-size:0.8rem;margin:4px 0 0;">Enriched</p>
            </div>
            <div style="text-align:center;padding:1rem;background:rgba(239,68,68,0.06);border-radius:8px;">
              ...
              <p style="color:var(--text-tertiary);font-size:0.8rem;margin:4px 0 0;">Errors</p>
            </div>
          ...
          <div style="max-height:300px;overflow-y:auto;">
            ${result.results.map(r => `
              <div style="display:flex;align-items:center;gap:0.75rem;padding:0.5rem;border-bottom:1px solid var(--border-color);">
                ...
                <span style="color:var(--text-tertiary);font-size:0.75rem;">${r.status === 'enriched' ? r.sources + ' sources' : r.error}</span>
              </div>
            `).join('')}
          </div>
        </div>
      ...
      this.loadStats();
      showToast(`${result.summary.enriched} leads enriched!`, 'success');
    } catch (err) {
  ...
  async searchLead() {
    ...
    if (!query) return showToast('Enter a name or CNPJ', 'warning');
    ...
    try {
      ...
      if (leads.length === 0) {
        resultsEl.innerHTML = '<div class="card" style="grid-column:1/-1;text-align:center;padding:2rem;"><p style="color:var(--text-tertiary);">No leads found</p></div>';
        return;
      }
      ...
      resultsEl.innerHTML = leads.map(lead => `
        <div class="card" style="padding:1.25rem;">
          <div style="display:flex;justify-content:space-between;align-items:start;margin-bottom:0.5rem;">
            ...
            <button class="btn btn-sm btn-primary" onclick="EnrichmentPage.enrichSingle('${lead.id}')" style="font-size:0.75rem;"><i data-lucide="sparkles"></i>Enrich</button>
          </div>
      ...
      showToast('Error searching: ' + err.message, 'danger');
    }
  },
